 ...
 *
 * Задача упражнения состоит в том, чтобы отфильтровать поток данных записей поездок на такси,
 * чтобы сохранить только поездки, которые начинаются и заканчиваются в пределах Нью-Йорка.
 * Полученный поток должен быть распечатан.
 *
 * Parameters:
